...
export function NearByCard() {
    ...
    return (
        <div className="p-4 bg-white dark:bg-slate-800 rounded-2xl flex items-center gap-4 hover:ring-2 ring-primary/30 transition-all cursor-pointer border border-slate-100 dark:border-slate-800 shadow-sm" onClick={()=>navigate('/restaurant/1')}>
