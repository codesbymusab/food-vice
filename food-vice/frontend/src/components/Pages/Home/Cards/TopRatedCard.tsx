...
export function TopRatedCard() {
    ...
    return (
        <div className="flex gap-4 p-4 bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-800 hover:shadow-xl transition-shadow cursor-pointer" onClick={()=>navigate('/restaurant/1')}>
