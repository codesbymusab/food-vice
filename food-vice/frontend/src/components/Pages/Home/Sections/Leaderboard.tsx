    ...
    return (
        <div className="bg-gradient-to-br from-primary to-orange-600 p-8 rounded-3xl shadow-xl shadow-primary/10 text-white">
            ...
            <div className="space-y-4">
                <div className="flex items-center gap-4 bg-white/10 backdrop-blur p-4 rounded-2xl hover:scale-105 cursor-pointer hover:bg-white/20">
                ...
                <div className="flex items-center gap-4 bg-white/5 backdrop-blur p-4 rounded-2xl hover:scale-105 cursor-pointer hover:bg-white/20">
