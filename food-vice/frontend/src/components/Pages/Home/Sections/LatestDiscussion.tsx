    ...
    return (
        <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800">
            <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-xs font-bold text-slate-400 uppercase">View All</button>
            </div>
            <div className="space-y-6">
                <div className="group cursor-pointer border-b border-slate-100 dark:border-slate-700 pb-4">
