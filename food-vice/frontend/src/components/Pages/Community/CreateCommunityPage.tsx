...
export function CreateCommunityPage() {
    ...
    const addRule = () => {
        if (newRule.trim()) {
            setGuidelines([...guidelines, newRule.trim()])
            setNewRule('')
        }
    }
                        ...
                        <section className="space-y-6">
                            ...
                            <div className="p-6 bg-surface-container rounded-xl space-y-4">
                                ...
                                {guidelines.map((rule, index) => (
                                    <div key={index} className="flex items-center justify-between p-4 bg-white rounded-lg border border-outline shadow-sm">
                                        <div className="flex items-center gap-3">
